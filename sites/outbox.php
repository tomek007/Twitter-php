...
<html>
    ...
    <body>
        ...
        <div class="mainPanel">
            ...
            <div class='messages'>   
                <div class='priv'>
                    <div class="inbox">outbox</div>
                    <?php
                    $messages = message::loadMessagesSenderId($conn, $_SESSION['id']);
                    for ($i = 0; $i < count($messages); $i++) {

                        if ($i % 2 === 0) {

                            echo "<div class='msgName black'><p class='sendername'>" .
                            '<a href=userpagina.php?identify=' . $messages[$i]->getReciverId() . '>' .
                            $messages[$i]->reciverName . "</a></p></div>";
