        ...
        <div class="mainPanel">
            ...
            <div class='newPass'>
                <form action="" method="POST">
                    <ul>
                        <li class="newPassLi">if new email will be set up page logut</li>
                        <li class="newPassLi"><input type="email" name="newPassword" pattern=".{5,16}" placeholder="new email 5-16 char. "></li>
                        <li class="newPassLi"><input type="email" name="confirm" pattern=".{5,16}" placeholder="confirm email"></li>
